...
public class BillAdapter extends RecyclerView.Adapter<BillAdapter.BillHolder> {
    ...
    public interface BillItemClickListener{
        void onBillItemClick(String clickedBillId, String customerName, String phoneNumber,String mot, String vehNumber, String uniqueId, String gst, String invoiceNo);
    }
    ...
    public void onBindViewHolder(BillHolder holder, int position) {
        if(mCursor.moveToPosition(position)){
            ...
            String gstNumber = mCursor.getString(mCursor.getColumnIndex(GSTBillingEntry.PRIMARY_COLUMN_GSTIN));
            String mot = mCursor.getString(mCursor.getColumnIndex(GSTBillingEntry.PRIMARY_COLUMN_MOT));
            String vehNumber = mCursor.getString(mCursor.getColumnIndex(GSTBillingEntry.PRIMARY_COLUMN_VEHNO));
            String uniqueID = mCursor.getString(mCursor.getColumnIndex(GSTBillingEntry.PRIMARY_COLUMN_UNQID));
            String date = mCursor.getString(mCursor.getColumnIndex(GSTBillingEntry.PRIMARY_COLUMN_DATE));
            String invoiceNo = mCursor.getString(mCursor.getColumnIndex(GSTBillingEntry.PRIMARY_COLUMN_INVOICENO));
            ...
            holder.snoTv.setText(String.valueOf(id));
            ...
            holder.itemView.setTag(R.id.bill_detail_gstin, gstNumber );
            holder.itemView.setTag(R.id.bill_detail_mot,mot);
            holder.itemView.setTag(R.id.bill_detail_vehNo,vehNumber);
            holder.itemView.setTag(R.id.bill_detail_uniqueId,uniqueID);
            holder.itemView.setTag(R.id.bill_detail_invoiceNo,invoiceNo);
    ...
    public class BillHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        TextView customerNameTv, phoneNumberTv, totalAmountTv, dateTv, snoTv;
        View divider;
        ...
        public BillHolder(View itemView) {
            ...
            snoTv = (TextView)itemView.findViewById(R.id.bill_sno);
        ...
        public void onClick(View v) {
            clickListener.onBillItemClick(
                    ...
                    (String)itemView.getTag(R.id.bill_detail_gstin),
                    (String)itemView.getTag(R.id.bill_detail_mot),
                    (String)itemView.getTag(R.id.bill_detail_vehNo),
                    (String)itemView.getTag(R.id.bill_detail_uniqueId),
                    (String)itemView.getTag(R.id.bill_detail_invoiceNo)
