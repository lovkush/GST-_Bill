...
public class GSTBillingContract {
    ...
    public static final class GSTBillingEntry implements BaseColumns {
        ...
        public static final String PRIMARY_COLUMN_GSTIN = "gstin" ;
        public static final String PRIMARY_COLUMN_MOT = "mot" ;
        public static final String PRIMARY_COLUMN_VEHNO = "vehNumber" ;
        public static final String PRIMARY_COLUMN_UNQID = "uniqueId" ;
        public static final String PRIMARY_COLUMN_DATE = "billDate";
        public static final String PRIMARY_COLUMN_STATUS = "billStatus";
        public static final String PRIMARY_COLUMN_INVOICENO = "invoiceNo";
    }
    ...
    public static final class GSTBillingCustomerEntry implements BaseColumns{
        ...
        public static final String SECONDARY_COLUMN_HSN = "hsn";
    }
