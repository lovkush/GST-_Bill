...
public class GSTBillingDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String CREATE_TABLE = "CREATE TABLE "  + GSTBillingContract.GSTBillingEntry.PRIMARY_TABLE_NAME + " (" +
                ...
                GSTBillingContract.GSTBillingEntry.PRIMARY_COLUMN_GSTIN + " TEXT NOT NULL, " +
                GSTBillingContract.GSTBillingEntry.PRIMARY_COLUMN_MOT + " TEXT NOT NULL, " +
                GSTBillingContract.GSTBillingEntry.PRIMARY_COLUMN_VEHNO + " TEXT NOT NULL, " +
                GSTBillingContract.GSTBillingEntry.PRIMARY_COLUMN_UNQID + " TEXT NOT NULL, " +
                GSTBillingContract.GSTBillingEntry.PRIMARY_COLUMN_DATE + " TEXT NOT NULL, " +
                GSTBillingContract.GSTBillingEntry.PRIMARY_COLUMN_INVOICENO + " TEXT NOT NULL, " +
    ...
    public static void createBillTable(SQLiteDatabase db, String billId){
        ...
        final String CREATE_TABLE = "CREATE TABLE "  + GSTBillingContract.GSTBillingCustomerEntry.SECONDARY_TABLE_NAME + billId + " (" +
                ...
                GSTBillingContract.GSTBillingCustomerEntry.SECONDARY_COLUMN_HSN + " TEXT NOT NULL, " +
