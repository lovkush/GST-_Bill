...
public class SavePDFAdapter extends RecyclerView.Adapter<SavePDFAdapter.SavePDFHolder> {
    ...
    public void onBindViewHolder(SavePDFHolder holder, int position) {
        if(mCursor.moveToPosition(position)){
            ...
            String hsnValue = mCursor.getString(mCursor.getColumnIndex(GSTBillingContract.GSTBillingCustomerEntry.SECONDARY_COLUMN_HSN));
            ...
            holder.hsnpdf.setText(hsnValue);
    ...
    public class SavePDFHolder extends RecyclerView.ViewHolder {
        ...
        TextView snoPdf, itemPdf, hsnpdf, ratePdf, qtyPdf, taxableValuePdf, taxSlabPdf, cgstPdf, sgstPdf ;
        ...
        public SavePDFHolder(View itemView) {
            ...
            hsnpdf =  (TextView) itemView.findViewById(R.id.pdf_hsn);
